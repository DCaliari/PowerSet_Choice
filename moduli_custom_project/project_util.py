...
FULLPATH_CARTELLA_IMG_L1 = os.path.join(FULLPATH_CARTELLA_IMG_LANGUAGE, 'Language_1')
FULLPATH_CARTELLA_IMG_L2 = os.path.join(FULLPATH_CARTELLA_IMG_LANGUAGE, 'Language_2')
FULLPATH_CARTELLA_IMG_L3 = os.path.join(FULLPATH_CARTELLA_IMG_LANGUAGE, 'Language_3')
FULLPATH_CARTELLA_IMG_L4 = os.path.join(FULLPATH_CARTELLA_IMG_LANGUAGE, 'Language_4')
FULLPATH_CARTELLA_IMG_L5 = os.path.join(FULLPATH_CARTELLA_IMG_LANGUAGE, 'Language_5')
FULLPATH_CARTELLA_IMG_L6 = os.path.join(FULLPATH_CARTELLA_IMG_LANGUAGE, 'Language_6')
FULLPATH_CARTELLA_IMG_L7 = os.path.join(FULLPATH_CARTELLA_IMG_LANGUAGE, 'Language_7')
