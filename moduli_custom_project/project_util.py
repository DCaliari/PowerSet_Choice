...
FULLPATH_CARTELLA_IMG_LOGIC9 = os.path.join(FULLPATH_CARTELLA_IMG_LOGIC_ANSWERS, 'Raven_9')
FULLPATH_CARTELLA_IMG_LOGIC10 = os.path.join(FULLPATH_CARTELLA_IMG_LOGIC_ANSWERS, 'Raven_10')
FULLPATH_CARTELLA_IMG_LOGIC11 = os.path.join(FULLPATH_CARTELLA_IMG_LOGIC_ANSWERS, 'Raven_11')
FULLPATH_CARTELLA_IMG_LOGIC12 = os.path.join(FULLPATH_CARTELLA_IMG_LOGIC_ANSWERS, 'Raven_12')
FULLPATH_CARTELLA_IMG_LOGIC13 = os.path.join(FULLPATH_CARTELLA_IMG_LOGIC_ANSWERS, 'Raven_13')
FULLPATH_CARTELLA_IMG_LOGIC14 = os.path.join(FULLPATH_CARTELLA_IMG_LOGIC_ANSWERS, 'Raven_14')
